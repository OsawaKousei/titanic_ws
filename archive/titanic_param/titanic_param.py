...
for epoch in range(EPOCH):
    ...
    if earlystopping.early_stop:
        ...
        with open("./titanic_param/params/hyperparameter.txt", "w") as f:
            f.write(
...
plt.savefig("./titanic_param/graphs/accuracy_image.png")
plt.show()
...
# 予測結果をcsvファイルに保存
y_pred.to_csv("./titanic_param/predictions/submission.csv", index=True)  # type: ignore
