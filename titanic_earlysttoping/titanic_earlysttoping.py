...
# データの読み込み
path = "./titanic_earlysttoping/fixed_data/"
...
for epoch in range(EPOCH):
    ...
    if earlystopping.early_stop:
        ...
        with open(
            "./titanic_earlysttoping/params/hyperparameter.txt", "w"
        ) as f:
            f.write(
...
# 予測結果をcsvファイルに保存
y_pred.to_csv("./titanic_earlysttoping/predictions/submission.csv", index=True)  # type: ignore
