...
test["Age"] = imputer.transform(
    np.hstack((test_scaled_features, np.expand_dims(test["Age"], axis=1)))
)[:, -1]
...
warnings.filterwarnings(
    "ignore", category=UserWarning, module="lightgbm"
)  # LightGBMの警告を無視
...
# モデルの評価
results = {"Model": [], "Accuracy": [], "F1 Score": [], "AUC-ROC": []}
