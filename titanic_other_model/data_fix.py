...
# データの読み込み
path = "~/titanic_ws/titanic_other_model/data/"
...
# csvファイルに保存
X.to_csv("./titanic_other_model/fixed_data/X.csv", index=False)
Y.to_csv("./titanic_other_model/fixed_data/Y.csv", index=False)
